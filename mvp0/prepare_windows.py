...
from mvp0.labels import STAGE_TO_ID, PrimitiveBoundary
from mvp0.schemas import EpisodeMeta, EpisodeSpec, WindowRecord
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Prepare MVP-0 windows from episode directories.")
