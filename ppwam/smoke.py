...
from ppwam.eval import run_eval
from ppwam.extract_vision_features import extract_mock_features
from ppwam.make_counterfactuals import make_counterfactuals
from ppwam.plot import run_plot
...
def run_smoke(
    root: str | Path,
    config_path: str | Path = "configs/debug.yaml",
    num_episodes: int = 5,
    num_frames: int = 24,
    clean: bool = True,
) -> None:
