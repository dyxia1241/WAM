...
from ppwam.eval import write_predictions
from ppwam.manifest import write_manifest
from ppwam.train import build_model, make_loaders, train
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--config", default="configs/archive/gm100_prompt_formal.yaml")
